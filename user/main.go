...
import (
	...
	service2 "github.com/ayanamimcy/gopass/user/domain/service"
	...
	"github.com/ayanamimcy/gopass/user/handler"
	//hystrix2 "github.com/ayanamimcy/gopass/user/plugin/hystrix"
	"strconv"
	"k8s.io/client-go/kubernetes"
	"k8s.io/client-go/tools/clientcmd"
	"k8s.io/client-go/util/homedir"
	user "github.com/ayanamimcy/gopass/user/proto/user"
